        ...
        <Box>
          ...
          <FadeUp>
            <Text mt={5} mb={{ base: 0, md: 10 }} textAlign={"justify"}>
              ...
              also support it with services such as social media marketing,
              search engine optimization (SEO), and video analytics. Video
              Chatbots are trending in 2023, and we are working on developing
              and launching Video Chatbots in UAE and the GCC. We can created
              content in English, Arabic, Russian, Chinese and more, depending
              on your target audience.
              <br />
              <br />
              Social media videos are short-form videos that are created
              specifically for social media platforms such as Facebook,
              Instagram, Twitter, and TikTok. These videos are designed to be
              engaging, shareable, and easy to consume on mobile devices.
              <br />
              <br />
            </Text>
          </FadeUp>
                ...
                <OrderedList my={"6"}>
                  <li>
                    <Text className="main-p">
                      <b>Explainer videos:</b> These videos are used to explain
                      a product, service, or concept to an audience in an
                      engaging way.
                    </Text>
                  </li>
                  <li>
                    <Text mt="5" className="main-p">
                      ...
                      specific requirements of a project. WordPress
                      customization involves creating custom themes, plugins,
                      and widgets.
                    </Text>
                  </li>
                  <li>
                  ...
                  <li>
                    <Text mt="5" className="main-p">
                      <b>Behind-the-scenes videos:</b> These videos give viewers
                      a behind-the-scenes look at a business or individual,
                      giving them a glimpse into the creative process.
                    </Text>
                  </li>
                  <li>
                    <Text mt="5" className="main-p">
                      <b>Customer testimonials:</b> These videos feature
                      satisfied customers talking about their experiences with a
                      product or service.
                    </Text>
                  </li>
                  <li>
