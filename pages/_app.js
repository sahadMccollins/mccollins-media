...
function MyApp({ Component, pageProps: { session, ...pageProps } }) {
  ...
  const metaData = {
    ...
    "/services/search-engine-optimization": {
      ...
      description:
        "Mccollins offer the best range of SEO services in Dubai, Abu Dhabi and across the globe at affordable price. Our team works for your website traffic, ranking and visibility with the best strategies.Get the seo services in UAE by calling- +971 055 956 4135",
    },
