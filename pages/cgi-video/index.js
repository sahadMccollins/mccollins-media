  ...
  return (
    <>
      ...
      <div className="film-prd CgiLanding">
        ...
        <main>
          {!isDesktop && <CgiVideoAutoplay src1="/cgi/dih.mp4" />}
                  ...
                  <div className="container">
                    <div className="row">
                      <div className="col-md-4">
                        ...
                        {!isDesktop && <CgiVideoAutoplay src1="/cgi/1.mp4" />}
                      </div>
                      <div className="col-md-4">
                        {isDesktop && (
                          <div
                        ...
                        {!isDesktop && <CgiVideoAutoplay src1="/cgi/2.mp4" />}
                      </div>
                      <div className="col-md-4">
                        {isDesktop && (
                          <div
                        ...
                        {!isDesktop && <CgiVideoAutoplay src1="/cgi/3.mp4" />}
                      </div>
                      <div className="col-md-4">
                        {isDesktop && (
                          <div
                        ...
                        {!isDesktop && <CgiVideoAutoplay src1="/cgi/4.mp4" />}
                      </div>
                      <div className="col-md-4">
                        {isDesktop && (
                          <div
                        ...
                        {!isDesktop && <CgiVideoAutoplay src1="/cgi/5.mp4" />}
                      </div>
                      <div className="col-md-4">
                        {isDesktop && (
                          <div
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-6">
                ...
                <div className="ft4">
                  <a href="tel:+971 0559564135">
                    <span>Phone&nbsp;:</span>&nbsp;+971 0559564135
                  </a>
                  <br />
        ...
        <div className="stickyBtmBtn">
          ...
          <a href="tel:+971 0559564135" target="_blank">
            <div className="SBBtn">
              <img src="/assets/image/icons/call.svg" width="18px" />
              &nbsp; Call Us On : +971 0559564135
            </div>
          </a>
          <a
            href="https://api.whatsapp.com/send?phone=+971 0559564135&text=I%20would%20like%20to%20know%20more%20about%20McCollins%20Media"
