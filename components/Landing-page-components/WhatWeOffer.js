...
const WhatWeOffer1 = () => {
  return (
    <div className="WhatWeOffer pd-common-container">
      <div className="icontainer">
        <div class="rowBox1 Ar1">
          <div class="rowBox1L">
...
Business
          ...
          <div class="rowBox1R">
            <div class="T4">
            Boost your online presence with the leading social media agency. Our expert
Team offers tailored strategies and effective solutions to drive traffic and maximize conversion.
            </div>
          </div>
        </div>
        <div className="WhatWeOfrWrp">
            <div className="OurOffers irow">
                <div className="OfferItem irc3">
                    <a className="OfferItemBox color11" href="/contact">
                        <div className="OfT1">
                ...
                <div className="OfferItem irc3">
                    <a className="OfferItemBox color22" href="/contact">
                        <div className="OfT1">
                            <span className="OftIcon">
                                <span className="w w5">&nbsp;</span>
                            </span>
                ...
                <div className="OfferItem irc3">
                    <a className="OfferItemBox color33" href="/contact">
                        <div className="OfT1">
                            <span className="OftIcon">
                                <span className="w w5">&nbsp;</span>
                            </span>
                ...
                <div className="OfferItem irc3">
                    <a className="OfferItemBox color44" href="/contact">
                        <div className="OfT1">
                            <span className="OftIcon">
                                <span className="w w5">&nbsp;</span>
                            </span>
                ...
                <div className="OfferItem irc3">
                    <a className="OfferItemBox color55" href="/contact">
                        <div className="OfT1">
                            <span className="OftIcon">
                                <span className="w w5">&nbsp;</span>
                            </span>
                ...
                <div className="OfferItem irc3">
                    <a className="OfferItemBox color66" href="/contact">
                        <div className="OfT1">
                            <span className="OftIcon">
                                <span className="w w5">&nbsp;</span>
                            </span>
